---
title: Sharing R code without sharing R code
subtitle: Sharing R code without sharing R code
description: |
...
Chairs: Sharing R code without sharing R code
...
We are waiting on content from Rohan and Min. Once recieved this page will be updated.
